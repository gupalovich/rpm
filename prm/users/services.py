...
def set_parent_in_smart(user):
    ...
    contract = w3.eth.contract(address=Web3.toChecksumAddress(settings.BSCSCAN_CONTRACT_ADDRESS), abi=abi)
    ...
    tx = contract.functions.setParent(
        ...
        "chainId": 97, "gas": 100000, "gasPrice": w3.toWei("10", "gwei"), "nonce": nonce
    })
